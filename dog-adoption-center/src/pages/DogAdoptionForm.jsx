...
//       }
//       console.log('Dog posted successfully:', response.data);
//     } catch (error) {
...
//                 <div className='input'>
//                   <label>Breed:</label>
//                   <input type="text" name="breed" value={formData.breed} onChange={handleChange} placeholder='Enter the breed' required />
//                 </div>
//                 <div className='input'>
//                   <label>Vaccinated:</label>
//                   <input type="checkbox" name="vaccinated" checked={formData.vaccinated} placeholder='Are they vaccinated?' onChange={handleChange} />
//                 </div>
//                 <div className='input'>
//                   <label>Location:</label>
//                   <input type="text" name="location" value={formData.location} onChange={handleChange} placeholder='Enter the location' required />
//                 </div>
//                 <div className='input'>
//                   <label>Contact:</label>
